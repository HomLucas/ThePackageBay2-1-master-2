package com.example.lucas.thepackagebay;
...
public class DB {
    ...
    public static class establishCon extends AsyncTask<String, Void, ArrayList<ArrayList<String>>> {
        protected ArrayList<ArrayList<String>> doInBackground(String... params) {
            ...
            String url = "jdbc:postgresql://ec2-107-21-114-132.compute-1.amazonaws.com:5432/d43iu4v6ff62nd?user=lfcefvlkwbnebw&password=Gmkksy-p7NXnRl6AhdxMP9HWvW&ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory";
            try {
